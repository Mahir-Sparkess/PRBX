...
class Generator(nn.Module):
    def __init__(self, in_channels=3, features=64, render=False):
        ...
        self.final_up = nn.Sequential(
            nn.ConvTranspose2d(features * 2, in_channels * 4, kernel_size=4, stride=2, padding=1),
            nn.Tanh(),
        )
